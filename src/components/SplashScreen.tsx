...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  if (!isVisible) {
    return (
      <div className="fixed inset-0 bg-background flex flex-col items-center justify-center z-50 opacity-0 transition-opacity duration-300 pointer-events-none">
